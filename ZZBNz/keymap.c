...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [2] = LAYOUT_voyager(
    ...
    TD(DANCE_4),    LCTL(LSFT(KC_TAB)),RGUI(RSFT(KC_DOWN)),RGUI(RSFT(KC_UP)),LCTL(KC_TAB),   TD(DANCE_5),                                    KC_KP_1,        KC_KP_2,        KC_KP_3,        KC_KP_DOT,      KC_COMMA,       TD(DANCE_9),    
                                                    KC_TRANSPARENT, TT(4),                                          KC_TRANSPARENT, DUAL_FUNC_3
  ),
  [3] = LAYOUT_voyager(
  ...
  [4] = LAYOUT_voyager(
    ...
    KC_NO,          KC_MS_WH_LEFT,  KC_MS_WH_UP,    KC_MS_WH_DOWN,  KC_MS_WH_RIGHT, KC_NO,                                          KC_NO,          KC_MS_BTN7,     KC_MS_BTN8,     KC_NO,          KC_NO,          KC_NO,          
  ...
  [5] = LAYOUT_voyager(
    ...
    KC_NO,          DUAL_FUNC_4,    TD(DANCE_10),   TD(DANCE_11),   LGUI(LSFT(KC_D)),TD(DANCE_12),                                   LGUI(LSFT(KC_O)),DUAL_FUNC_6,    DUAL_FUNC_7,    DUAL_FUNC_8,    DUAL_FUNC_9,    KC_TRANSPARENT, 
  ...
  [7] = LAYOUT_voyager(
    TD(DANCE_20),   KC_1,           DUAL_FUNC_10,   DUAL_FUNC_11,   KC_4,           KC_5,                                           KC_F1,          KC_F2,          KC_F3,          KC_F4,          KC_F5,          KC_DELETE,      
...
const uint16_t PROGMEM combo7[] = { TT(2), KC_TAB, COMBO_END};
