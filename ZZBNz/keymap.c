...
#define DUAL_FUNC_10 LT(2, KC_2)
#define DUAL_FUNC_11 LT(12, KC_F11)
#define DUAL_FUNC_12 LT(15, KC_G)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [2] = LAYOUT_voyager(
    KC_TRANSPARENT, KC_HOME,        KC_PGDN,        KC_PAGE_UP,     KC_END,         LALT(LGUI(LCTL(LSFT(KC_SPACE)))),                                TD(DANCE_5),    KC_UNDS,        KC_COLN,        KC_LPRN,        KC_RPRN,        TD(DANCE_6),    
    LALT(LCTL(LSFT(KC_N))),RCTL(KC_LEFT),  RCTL(KC_DOWN),  MAC_MISSION_CONTROL,RCTL(KC_RIGHT), LALT(KC_SPACE),                                 KC_KP_7,        KC_KP_8,        KC_KP_9,        KC_KP_MINUS,    KC_KP_SLASH,    TD(DANCE_7),    
  ...
  [5] = LAYOUT_voyager(
    ...
    KC_NO,          DUAL_FUNC_3,    TD(DANCE_8),    TD(DANCE_9),    LGUI(LSFT(KC_D)),TD(DANCE_10),                                   LGUI(LSFT(KC_O)),DUAL_FUNC_5,    DUAL_FUNC_6,    DUAL_FUNC_7,    DUAL_FUNC_8,    KC_TRANSPARENT, 
    TD(DANCE_11),   KC_NO,          KC_NO,          TD(DANCE_12),   TD(DANCE_13),   KC_NO,                                          KC_NO,          TD(DANCE_15),   TD(DANCE_16),   KC_NO,          KC_NO,          KC_NO,          
  ...
  [7] = LAYOUT_voyager(
    TD(DANCE_18),   KC_1,           DUAL_FUNC_9,    DUAL_FUNC_10,   KC_4,           KC_5,                                           KC_F1,          KC_F2,          KC_F3,          KC_F4,          KC_F5,          KC_TRANSPARENT, 
